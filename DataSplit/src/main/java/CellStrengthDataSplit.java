...
public class CellStrengthDataSplit {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = new Job(_conf, "CellStrengthDataSplit");
        job.setJarByClass(CellStrengthDataSplit.class);
    ...
    public static class DataSplitReduce extends Reducer<Text, Text, Text, Text> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            if (key.toString().contains("-")){
                ...
                buff = datas.getBytes();
                //设置HDFS目录
                dfs = new Path("/CellStrengthDatas/" +year+"/"+month+ "/"+day+ "/"+key.toString()+".txt");
                //写入
