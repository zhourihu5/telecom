...
object Updatas {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // kafka集群
    val kafkaParams=Map("metadata.broker.list"->"192.168.52.100:9092,192.168.52.110:9092,192.168.52.120:9092")
    //kafka topic
    ...
    //连接dashbord所需数据的数据库
    val conn_str = "jdbc:mysql://192.168.52.110:3306/telecom?user=root&password=123456"
