...
<body  >
				...
				<div class="header">
					<div class="panel panel-default">
						<p class="panel-heading">
							 <font  color="red" size="3px" ><b><spring:message code="usernwtips"></spring:message></b></font>
						</p>
					</div>
				</div>
			</div>
	...
	function showInfo(e){
		...
		window.location.href="<%=basePath%>view/PoinstsOverview/pointTileGeogOverview.jsp?lng="+e.point.lng+"&lat="+e.point.lat;
