...
<body  onload="gettime()" >
				...
				<div class="header">
					<div class="panel panel-default">
						<p class="panel-heading">
							 <font  color="red" size="3px" ><b><spring:message code="userrssitips"></spring:message></b></font>
						</p>
					</div>
				</div>
			</div>
	...
	function showInfo(e){
		 window.location.href="<%=basePath%>view/SignalCoverage/onerssiheatmap.jsp?lon="+e.point.lng+"&lat="+e.point.lat;
		}
