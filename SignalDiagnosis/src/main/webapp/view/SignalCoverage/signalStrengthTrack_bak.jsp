...
.landmark_img {
	background-image: url("<%=basePath%>img/radio.png");
	width: 120px;
	height: 30px;
	margin-left: auto;
	margin-right: auto;
					...
					<div class="row">
						<div>
							<div id="control1" class="form-group">
								<label class="col-sm-1 control-label" for="landmark">
									Landmark: </label>
								<div class="col-sm-2" >
									<div id="1" class="landmark_img" onclick="landmark(id)">
										<p>Landmark1</p>
									</div>
								</div>
								<div  class="col-sm-2" >
									<div id="2" class="landmark_img" onclick="landmark(id)">
										<p>Landmark2</p>
									</div>
								</div>
								<div class="col-sm-2">
									<div id="3" class="landmark_img" onclick="landmark(id)">
										<p>Landmark3</p>
									</div>
								</div>
								<div class="col-sm-2">
									<div id="4" class="landmark_img" onclick="landmark(id)">
										<p>Landmark4</p>
									</div>
								</div>
								<div class="col-sm-2">
									<div id="5" class="landmark_img" onclick="landmark(id)">
										<p>Landmark5</p>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div id="control">
							<div id="control2" class="form-group">
								<label class="col-sm-1 control-label" for="dateControl">
