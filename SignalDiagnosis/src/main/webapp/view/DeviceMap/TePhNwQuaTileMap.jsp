...
<body>
		...
		<div class="header">
			...
			<div id="control">
				<div id="control1" class="form-group">
					<label class="col-sm-2 control-label" for="dateControl"> 
                ...
                <div id="control4" class="form-group">
									<label class="col-sm-2 control-label" for="cellPhoneType"
										> <spring:message code="cellPhoneType"></spring:message>：
									</label>
									<div class="col-sm-2" >
										<select type="text" id="cellPhoneType" name="cellPhoneType"  class="form-control form-controlprovince">
			...
			<div class="control">
				...
				<div id="control3" class="form-group">
					<label class="col-sm-2 control-label" for="mobile_network_type">
						<spring:message code="mobile_network_type"></spring:message>:
					</label>
					<div class="col-sm-2">
						<select  id="mobile_network_type"
                 ...
                 <!-- 网络延迟 -->
                <div id="control4" class="form-group">
									<label class="col-sm-2 control-label" for="nwSpeed"
    ...
    ZoomControl.prototype.initialize = function(map){  
        ...
        //div.appendChild(document.createTextNode("放大2级"));  
         div.innerHTML="<ol style='font-size:15px;background: white;list-style: none;font-style: inherit;padding-left: 1px;margin-left:1px;margin-bottom:1px;'> <li style=''><a style='background-color:grey ;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>&lt;0KB/s</li><li ><a style='background-color:#600000'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>0-50KB/s</li><li ><a style='background-color:#ff9797'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>100-150KB/s</li><li ><a style='background-color:#bbffbb'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>150-200KB/s</li><li ><a style='background-color:#28ff28'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>200-300KB/s</li><li ><a style='background-color:#009100'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>&gt;300KB/s</li></ol>"  
        // 设置样式  
    ...
    function showNewMap(){
		...
		/* 网络制式  */
		var NWType=$("#mobile_network_type").val();
		/*  网络延迟  */
		var nwSpeed=$("#nwSpeed").val();
		
		var phType=$("#cellPhoneType").val();
		...
		alert(phType); */
       	...
       	map.clearOverlays();   
       	chag(opera,dat,NWType,nwSpeed,phType);  
   }
    ...
    function chag(){
     ...
     reqLoading(true);
	  ...
	  $.ajax({
   	   ...
   	   type:"post",
   	   url : '<%=basePath%>showTePhNwQuaTileMap',
	...
	$(document).ready(function(){
		$.ajax({
	    	   ...
	    	   type:"post",
	    	   url:"<%=basePath%>showTePhNwQuaType",
	    	   
	    	   dataType:"json",

	           success:function(data){
	              $("#cellPhoneType").html("");
	              $("#cellPhoneType").append("<option value='ALL'>ALL</option>");
	              $.each(data,function(i,item){
	            	 // alert(item.deviceModel);
	                  $("#cellPhoneType").append("<option value="+item.deviceModel+">"+item.deviceModel+"</option>");
	              });
	           }
