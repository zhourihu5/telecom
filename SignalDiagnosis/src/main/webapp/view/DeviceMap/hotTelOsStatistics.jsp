...
<body class=" theme-blue">
	<div style="width: 100%; height: 100%">
		<div class="header">
			...
			<form action="<%=basePath%>appTraffic_hotTelOsStatistics">
						...
						<div class="row">
							<div id="control">
								<div id="control1" class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" id="dateControl"  value="${dayTime}" name="dateTime" class="form-control">
									</div>
								</div>
								<c:choose>
									<c:when test="${sessionScope.user.role == varDesc.getRole('ADMIN')}">
										<div id="control2" class="form-group">
											...
											<div class="col-sm-3" style="width: 15%;">
												<select type="text" id="nwOperator" name="network_name" class="form-control">
								...
								<div id="control3" class="form-group">
									...
									<div class="col-sm-3" style="width: 15%;">
										<select type="text" id="speedType" name="speed_type"  class="form-control">
											<c:choose>
			...
			<c:otherwise>
				...
				<div id="page-stats" class="panel-collapse panel-body collapse in">
					<div class="row" id="report">
						...
						<div id="reportRight" style="height: 650px;; display: inline; float: left; width: 35%;"></div>
					</div>
				</div>
			</div>
			</c:otherwise>
	...
	<script src="<%=basePath%>js/echarts-all.js"></script>
		<script type="text/javascript">
		var main = echarts.init(document.getElementById('reportLeft'));
		var optionMain = ${optionStr};
		 /* alert(option); */
		main.setOption(optionMain);
	</script>
	<script type="text/javascript">
		var pie = echarts.init(document.getElementById('reportRight'));
		var optionPie = ${pieStr};
		 /* alert(option); */
