...
<script type="text/javascript"
	src="<%=basePath%>js/date/jquery-1.3.1.min.js"></script>
<script type="text/javascript"
...
<body class=" theme-blue">
	<div style="width: 100%; height: 100%">
		<div class="header">
			...
			<form action="<%=basePath%>appTraffic_hotAppTrafficStatistics">
							...
							<div id="control">
								...
								<div class="col-sm-2">
									<button type="submit"  type="button" class="btn btn-danger" 
										onclick="testPointRanking_control()">
