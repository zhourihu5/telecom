...
<%-- 				<div id="control1" class="form-group">
					<label class="col-sm-2 control-label" for="dateControl"> <spring:message
...
<script type="text/javascript">
  ...
  function returns(){
	   ...
	   window.location.href="<%=basePath%>view/AppMap/showJM.jsp";
  ...
  function showlogo(tableCenterLng,tableCenterLat,companyModel,count){ 
	  ...
	  if (companyModel=="NULL"){
		 // alert(2);
		  ...
		  var label = new BMap.PanoramaLabel(companyModel, labelOptions);
