...
<body class=" theme-blue">
	<div style="width: 100%; height: 100%">
		<div class="header">
			...
			<form action="<%=basePath%>nwquality_terminalTrafficRateRank">
	...
	<script type="text/javascript">
		var terminalTrafficRateRank = echarts.init(document.getElementById('main'));
		var option = ${optionStr};
		 /* alert(option); */
		terminalTrafficRateRank.setOption(option);
	</script>
