...
<!-- 时间插件 -->
<%-- <script type="text/javascript" src="<%=basePath%>js/date/jquery-1.3.1.min.js"></script> --%>
<!-- <script src="js/jquery-1.11.1.js" type="text/javascript"></script> -->
<script src="<%=basePath %>js/jquery-1.7.2.min.js"></script>
<script src="<%=basePath%>js/date/jquery-ui-1.7.1.custom.min.js"></script>
<script src="<%=basePath%>js/date/daterangepicker.jQuery.js"></script>
...
<body class=" theme-blue">
				...
				<div class="panel-body">
					<div class="row">
						<div id="control">
							...
							<div class="col-sm-2">
								<button type="button" class="btn btn-danger" onclick="dataConnStatistics_control()">
	...
	//提交筛选信息，触发JS
		function dataConnStatistics_control(){
			/* 调用加载层 */
		    reqLoading(true);
			...
			$.ajax({
				type : "post",
				url : "<%=basePath%>dataConnectionStatistics_control",
				data : {"time_index_client" : dateControl,"network_name" : operator},
				dataType : "json",
				scriptCharset: 'utf-8', 
				success : function(data) {
					/* 调用加载层 */
				     reqLoading(false);
					var dataConnStatisticsChart_control = echarts.init(document.getElementById('main'));
					dataConnStatisticsChart_control.setOption(data);
				}
			}); 
		}
		//左边树导航栏触发
		var dataConnStatisticsChart = echarts.init(document.getElementById('main'));
		var option = ${optionStr};
		dataConnStatisticsChart.setOption(option);
